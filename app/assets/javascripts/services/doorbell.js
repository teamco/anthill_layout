    ...
    return DoorbellPreferences.extend('DoorbellPreferences', {
        ...
        renderDoorbell: function renderDoorbell() {
            ...
            var $textfield = this.renderTextField({
                ...
                disabled: false,
                visible: true,
                value: preferences.doorbellAppKey || 'Mw3OcekXyqGyHwqnIkEjd1kUFwgwiersP7hA7bfHcSLgHggYxv9M9uVE0sJtWB0Y',
                validate: {
                    blank: true
                }
            });
        ...
        loadActivateDoorbell: function loadActivateDoorbell() {
            ...
            if (this.controller.isServiceActivated(appKey, activate)) {
                ...
                (function(d, t) {
                    var g = d.createElement(t);g.id = 'doorbellScript';g.type = 'text/javascript';g.async = true;g.src = 'https://embed.doorbell.io/button/3645?t='+(new Date().getTime());(d.getElementsByTagName('head')[0]||d.getElementsByTagName('body')[0]).appendChild(g);
                }(document, 'script'));
