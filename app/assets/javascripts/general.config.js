...
/**
 * General config.
 * @returns {{rollBarLoader: _rollBarLoader, localStorage: _localStorage}}
 */
function config() {
   ...
   * @private
   */
  function _rollBarLoader(token, env) {
    let _rollbarConfig = {
      accessToken: token,
  ...
  function _localStorage(storage, content) {
    ...
    let script = document.getElementById('preload');
    script.parentNode.removeChild(script);
  }

  return {
    rollBarLoader: _rollBarLoader,
