...
define(
     ...
     * @returns {*}
     */
    function defineWorkspaceDataView(BaseView, BasePreferencesElement, Header,
        Footer, WorkspaceDataContentElement, WorkspaceDataPreferencesElement,
        WorkspaceDataAddPageElement, WorkspaceDataElement) {
          ...
          'WorkspaceDataView', {
            ...
            renderPreferences: function renderPreferences(page) {
              ...
              this.elements.$preferences =
                  new WorkspaceDataPreferencesElement(this, {
