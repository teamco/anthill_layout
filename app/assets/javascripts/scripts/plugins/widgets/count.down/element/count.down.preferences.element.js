...
define([
...
], function defineCountDownPreferencesElement(PluginElement, WidgetPreferences) {
     ...
     */
    var CountDownPreferencesElement = function CountDownPreferencesElement(view, opts) {
