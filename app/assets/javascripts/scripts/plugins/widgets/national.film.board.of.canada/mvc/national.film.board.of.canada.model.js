...
define([
...
], function defineNationalFilmBoardOfCanadaModel(BaseModel, WidgetContentModel) {
    ...
    var NationalFilmBoardOfCanadaModel = function NationalFilmBoardOfCanadaModel() {
         ...
         * @type {{nationalfilmboardofcanadaEmbedCode: {type: string, disabled: boolean, value: string, visible: boolean}}}
         */
        this.preferences = {
