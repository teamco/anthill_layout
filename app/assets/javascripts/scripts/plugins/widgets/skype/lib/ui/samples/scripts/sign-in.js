...
$(function () {
  ...
  $('#btn-sign-in').click(function () {
    ...
    // client.personsAndGroupsManager.mePerson.displayName()); $(".menu
    // #sign-out").click(); $("#anonymous-join").addClass("disable"); },
    // function (error) { // if something goes wrong in either of the steps
    // above, // display the error message $(".modal").hide(); alert("Can't
    // sign in, please check the user name and password.");
    // window.location.reload(); console.log(error || 'Cannot sign in'); });
  });
