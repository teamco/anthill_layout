...
define([
...
], function defineCircuitLabPreferencesElement(PluginElement, WidgetPreferences) {
     ...
     */
    var CircuitLabPreferencesElement = function CircuitLabPreferencesElement(view, opts) {
