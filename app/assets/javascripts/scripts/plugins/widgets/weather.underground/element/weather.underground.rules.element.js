...
define([
...
], function defineWeatherUndergroundRulesElement(PluginElement, BaseWidgetRules) {
     ...
     */
    var WeatherUndergroundRulesElement = function WeatherUndergroundRulesElement(view, opts) {
