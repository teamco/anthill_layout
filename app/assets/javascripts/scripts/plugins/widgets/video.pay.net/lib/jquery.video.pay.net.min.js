/*!
 * jQuery VideoPayNet Plug-in
 * Show a stream of your online activity
 * @version   0.5.2
 * @author    Christian Vuerings et al.
 * @copyright Copyright 2014, Christian Vuerings - http://denbuzze.com
 * @license   https://github.com/christianv/jquery-videopaynet/blob/master/LICENSE MIT
 */
/*global jQuery */
;
(function ($) {
    ...
    /**
     * Initialize the videopaynet plug-in
     * @param {Object} config Configuration object
     */
    $.fn.video-pay-net = function (config) {

        // Make the plug-in chainable
        return this.each(function () {

            // The element where the videopaynet is linked to
            var outputElement = $(this),

            // Extend the default settings with the values passed
                settings = jQuery.extend({
                    // The name of the main videopaynet class
                    // We use this for the main ul class e.g. videopaynet
                    // and for the specific feeds e.g. videopaynet-twitter
                    classname: "videopaynet",
            ...
            // every feed
                ...
                load = function () {
                    ...
                    for (; i < j; i++) {
                        ...
                        if ($.fn.video.pay.net.feeds[config.service] &&
                            $.isFunction($.fn.video.pay.net.feeds[config.service]) &&
                            config.user) {
                            ...
                            $.fn.video.pay.net.feeds[config.service](config, finished);
                        }
     ...
     */
    $.fn.video.pay.net.createYqlUrl = function (query) {
     ...
     */
    $.fn.video.pay.net.feeds = $.fn.video.pay.net.feeds || {};
...
(function ($) {
    $.fn.video.pay.net.feeds.atom = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('select * from xml where url="' +
            config.user + '"'),
            dataType: 'jsonp',
...
(function ($) {
    $.fn.video.pay.net.feeds.bitbucket = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('select events.event,' +
...
(function ($) {
    $.fn.video.pay.net.feeds.bitly = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('select data.short_url, data.created, ' +
...
(function ($) {
    $.fn.video.pay.net.feeds.blogger = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('select * from xml where url="http://' +
...
(function ($) {
    $.fn.video.pay.net.feeds.citeulike = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.dailymotion = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('select * from xml where ' +
...
(function ($) {
    $.fn.video.pay.net.feeds.delicious = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.deviantart = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl(
...
(function ($) {
    $.fn.video.pay.net.feeds.disqus = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.dribbble = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.facebookpage = function (config, callback) {
...
(function ($) {
    ...
    $.fn.video.pay.net.feeds.fancy = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('SELECT * FROM xml ' +
...
(function ($) {
    $.fn.video.pay.net.feeds.flickr = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.foomark = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.formspring = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.forrst = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.foursquare = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('select * from rss where url=' +
...
(function ($) {
    $.fn.video.pay.net.feeds.gimmebar = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.github = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('select ' +
...
(function ($) {
    $.fn.video.pay.net.feeds.googleplus = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.hypem = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.instapaper = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.iusethis = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.lastfm = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.librarything = function (config, callback) {
...
(function ($) {
    ...
    $.fn.video.pay.net.feeds.linkedin = function (config, callback) {
        ...
        $.ajax({
            'url': $.fn.video.pay.net.createYqlUrl(createYql()),
            'cache': true,
            'data': {
...
(function ($) {
    $.fn.video.pay.net.feeds.mendeley = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.miso = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.mlkshk = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.pinboard = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.pocket = function (config, callback) {
        ...
        $.ajax({
            url: $.fn.video.pay.net.createYqlUrl('select * from xml where url=' + '"http://www.getpocket.com/users/' + config.user + '/feed/all/"'),
            dataType: 'json',
            success: function (data) {
...
(function ($) {
    $.fn.video.pay.net.feeds.posterous = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.quora = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.reddit = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.rss = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.slideshare = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.snipplr = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.stackoverflow = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.tumblr = function (config, callback) {
            ...
            getImage = function (post) {
                switch (post.type) {
                    ...
                    case 'video':
                        ...
                        // from a videopaynet - so don't try to embed these.
...
(function ($) {
    ...
    $.fn.video.pay.net.feeds.twitter = function (config, callback) {
        var template = $.extend({}, {
                "posted": '{{html tweet}}'
            },
            config.template);
...
(function ($) {
    $.fn.video.pay.net.feeds.vimeo = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.wikipedia = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.wordpress = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.youtube = function (config, callback) {
...
(function ($) {
    $.fn.video.pay.net.feeds.zotero = function (config, callback) {
