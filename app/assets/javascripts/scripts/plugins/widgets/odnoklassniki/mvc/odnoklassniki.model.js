...
define([
    ...
    var OdnoklassnikiModel = function OdnoklassnikiModel() {
         ...
         * @type {{
         *      odnoklassnikiGroupId: {type: string, disabled: boolean, value: string, visible: boolean},
         *      odnoklassnikiWidth: {type: string, disabled: boolean, value: number, visible: boolean},
         *      odnoklassnikiHeight: {type: string, disabled: boolean, value: number, visible: boolean}
         * }}
         */
        this.preferences = {
