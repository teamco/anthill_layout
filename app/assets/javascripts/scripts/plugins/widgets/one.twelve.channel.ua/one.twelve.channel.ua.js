...
define([
...
], function defineOneTwelveChannelUa(AntHill, MVC, Controller, Model, View, EventManager, Permission) {
    ...
    return OneTwelveChannelUa.extend('OneTwelveChannelUa', {
