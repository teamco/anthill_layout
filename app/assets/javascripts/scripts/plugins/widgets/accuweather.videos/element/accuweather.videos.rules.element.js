...
define([
...
], function defineAccuweatherVideosRulesElement(PluginElement, BaseWidgetRules) {
     ...
     */
    var AccuweatherVideosRulesElement = function AccuweatherVideosRulesElement(view, opts) {
