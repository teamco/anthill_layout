...
define([
    ...
    var DropboxModel = function DropboxModel() {
         ...
         *      dropboxBytes: {type: string, disabled: boolean, value: undefined, visible: boolean},
         *      dropboxIcon: {type: string, disabled: boolean, value: undefined, visible: boolean},
         *      dropboxFileName: {type: string, disabled: boolean, value: undefined, visible: boolean},
         *      dropboxDownload: {type: string, disabled: boolean, value: undefined, visible: boolean}
         * }}
         */
        this.preferences = {
            dropboxFileName: {
