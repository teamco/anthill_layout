...
define([
    ...
    var DatepickerModel = function DatepickerModel() {
         ...
         * @type {{
         *      datepickerShowWeek: {type: string, disabled: boolean, checked: boolean, visible: boolean, value: boolean},
         *      datepickerFirstDay: {type: string, disabled: boolean, list: *[], value: string, visible: boolean}
         * }}
         */
        this.preferences = {
            datepickerFirstDay: {
