...
define([
  ...
  'services/loggly'
    ...
    SiteConfigMetaDataPreferences, SiteConfigWidthPreferences,
    GoogleAnalyticsPreferences, SnapEngagePreferences, RaygunIOPreferences,
    GithubGistPreferences, InjectScriptPreferences, BigmirNetPreferences,
    YahooFlurryPreferences, RollbarNotifierPreferences, RapidEngagePreferences,
    DoorbellPreferences, WoopraPreferences, VirtualSpiritsPreferences,
    LogglyPreferences) {
      ...
      'SitePreferences', {
        ...
        thirdPartyPlugins: function thirdPartyPlugins() {
          ...
          function _showPluginConfig(index) {
            ...
            if (!plugin) {
              scope.logger.warn('Unable to detect plugin renderer', plugin,
                  index);
              return false;
            }
