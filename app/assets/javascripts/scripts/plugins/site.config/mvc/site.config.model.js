...
defineP([
  ...
  var SiteConfigModel = function SiteConfigModel() {
     ...
     * @type {{
         *      preferences: {title: string, description: string, event:
         *     string}, publish: {title: string, description: string}, import:
         *     {title: string, description: string, event: string}, export:
         *     {title: string, description: string, event: string}, cleanup:
         *     {title: string, description: string, event: string},
         *     widgetGenerator: {title: string, description: string, event:
         *     string}
         * }}
     */
    this.data = {
