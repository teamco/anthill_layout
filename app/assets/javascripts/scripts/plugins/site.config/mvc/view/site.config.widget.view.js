  ...
  return SiteConfigWidgetView.extend(
      'SiteConfigWidgetView', {
        ...
        renderWidgetsManager: function renderWidgetsManager() {
           ...
           */
          this.elements.$widgetgenerator =
              new SiteConfigWidgetsListElement(this, {});
        ...
        showWidgetsList: function showWidgetsList(widgets, show) {
          ...
          this.modalDialog({
            style: 'widget-list',
            type: 'info',
            title: this.i18n.t('widget.manager.list').
                replace(/\{1}/, widgets.length + ''),
         ...
         * @param {object} defaults
         */
        showWidgetExternal: function showWidgetExternal(widgets, types,
            defaults) {
