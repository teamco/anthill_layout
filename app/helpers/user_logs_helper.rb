module UserLogsHelper
  ...
  def user_td(user_log, expand='')
    [
        "<tr#{user_log.error_log.nil? ? '' : ' class=error'}><td class=\"nw\">",
  ...
  def user_trace(user_log, hide='')
    [
        ...
        "<li><span class=\"label label-default\">Id</span>#{link_to user_log_path(user_log), user_log_path(user_log)}</li>",
        ...
        "<li><span class=\"label label-default\">Referer</span>#{user_log.referer}</li>",
