...
defineP([
  ...
  return ExternalWidgetView.extend('ExternalWidgetView', {
    ...
    renderPreferences: function renderPreferences() {
      ...
      require(
          [this.scope.externalResource +
          'element/external.widget.preferences.element.js'],
          function _loadElement(ExternalWidgetPreferencesElement) {
            ...
            this.elements.$preferences =
                new ExternalWidgetPreferencesElement(this, {
    ...
    renderRules: function renderRules(widgetRules, contentRules) {
      ...
      require(
          [this.scope.externalResource +
          'element/external.widget.rules.element.js'],
