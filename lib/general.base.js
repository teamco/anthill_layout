...
(function() {
  ...
  function _loadPublic() {
    ...
    function _setup() {
      ...
      const config = require('../public/{{site}}/javascript/config.js');
      const listeners = require('../public/{{site}}/javascript/listeners.js');
      const permissions = require('../public/{{site}}/javascript/permissions.js');
